...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    private Boolean needPaddingStatusBar = false;
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        mInsetForeground = a.getDrawable(R.styleable.ScrimInsetsView_scrimInsetsViewInsetForeground);
        needPaddingStatusBar = false;
